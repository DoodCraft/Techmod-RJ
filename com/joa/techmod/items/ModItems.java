...
public final class ModItems {
	...
	public static ArmorMaterial CYANITEA = EnumHelper.addArmorMaterial("CYANITEA", "techmod:cyanitea", 37, new int[]{3, 8, 6, 3}, 8);
	public static ArmorMaterial ZESTORENA = EnumHelper.addArmorMaterial("ZESTORENA", "techmod:zestorena", 45, new int []{3,  8, 6, 3}, 45);
